...
img=Image.open(r"C:\Users\SHOURYA GUPTA\OneDrive\Desktop\CG group project\eggcatcherbg.jpeg")
c.image=ImageTk.PhotoImage(img)
c.create_image(0,0,image=c.image,anchor='nw')
c.pack()

#color cycle
color_cycle = cycle(['blue' ,'violet', 'pink' , 'yellow','green' , 'red','black'])
...
#defining score  and lives of the game
score = 0
